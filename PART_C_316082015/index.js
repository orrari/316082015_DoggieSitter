...
// mytrips route
app.get('/myTrips', ensureAuthenticated, CRUD.getMyTrips);

// availableTrips route
app.get('/availableTrips', ensureAuthenticated, CRUD.getAvailableTrips);

// myRequests route
app.get('/myRequests', ensureAuthenticated, CRUD.getMyRequests);

//createNewRequest route
app.get('/createNewRequest/:id', ensureAuthenticated, CRUD.createNewRequest);
